...
class SyringeDeviceSim :
    public QDialog,
    public ISyringeDevice
{
    Q_OBJECT

public:
    SyringeDeviceSim(int device_num, DeviceEvent device_event);
    ~SyringeDeviceSim();
...
public:
    ...
    virtual int PumpBlood() override;   // 抽血
