...
class ArmPlateDeviceSim :
    public QDialog,
    public IArmPlateDevice
{
    Q_OBJECT

public:
    ArmPlateDeviceSim(int device_num, DeviceEvent device_event);
    ~ArmPlateDeviceSim();
...
public:
    ...
    virtual int ArmBand() override;  // 手臂轧带
    virtual int ArmLooseBand() override;  // 手臂松开轧带
